...
exe = EXE(pyz,
          ...
          strip=None,
          upx=False,
          icon='icons/electrum-doged.ico',
          console=False)
          # The console True makes an annoying black box pop up, but it does make electrum-doged output command line commands, with this turned off no output will be given but commands can still be used
